...
const SignInComponent = clerkConfigured
  ? dynamic(
      () => import("@clerk/nextjs").then((mod) => ({ default: (mod as any).SignIn })),
      { ssr: false, loading: () => <div>Loading...</div> }
    )
  : null;

export default function SignInPage() {
  if (clerkConfigured && SignInComponent) {
    return (
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white dark:bg-dark-800 rounded-xl border border-gray-200 dark:border-dark-700 p-8 shadow-lg">
            <div className="text-center py-12">
              <SignInComponent routing="hash" redirectUrl="/dashboard" />
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="bg-white dark:bg-dark-800 rounded-xl border border-gray-200 dark:border-dark-700 p-8 shadow-lg">
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm mb-6">
              To enable sign-in, configure your Clerk credentials in <code className="bg-gray-100 dark:bg-dark-700 px-2 py-1 rounded">.env.local</code>.
            </p>
            <ol className="text-left text-sm text-gray-600 dark:text-gray-400 mb-6 space-y-2">
              <li>
                1. Create a Clerk account at <a href="https://clerk.com" className="text-primary-600 hover:underline" target="_blank" rel="noopener noreferrer">clerk.com</a>
              </li>
              <li>2. Copy your Publishable Key</li>
              <li>3. Set <code className="bg-gray-100 dark:bg-dark-700 px-2 py-1 rounded">NEXT_PUBLIC_CLERK_PUBLISHABLE_KEY</code> and <code className="bg-gray-100 dark:bg-dark-700 px-2 py-1 rounded">CLERK_SECRET_KEY</code></li>
