...
const SignUpComponent = clerkConfigured
  ? dynamic(
      () => import("@clerk/nextjs").then((mod) => ({ default: (mod as any).SignUp })),
        ...
        <div className="bg-white dark:bg-dark-800 rounded-xl border border-gray-200 dark:border-dark-700 p-8 shadow-lg">
          <div className="text-center py-12">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm mb-6">
              To enable sign-up, configure your Clerk credentials in <code className="bg-gray-100 dark:bg-dark-700 px-2 py-1 rounded">.env.local</code>.
            </p>
